...
?>
<?php 
$ct = mysqli_query($conn,"select * from tb_category WHERE category_id");
$ct1 = mysqli_num_rows($ct);
?>
<?php 
$img = mysqli_query($conn,"select * from tb_image where  image_id");
$img1 = mysqli_num_rows($img);
?> 
  <div class="main-content">
           <div class="overview">
               <div class="card">
